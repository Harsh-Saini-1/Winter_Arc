      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="text-center mb-4">
            ...
            <p className="text-blue-200">90 Days of Coding Excellence</p>
          </div>
          <Card className="border-blue-500/20 bg-slate-900/50 backdrop-blur">
            <CardHeader>
              <CardTitle className="text-2xl text-white">Login</CardTitle>
              <CardDescription className="text-slate-300">
                Enter your credentials to continue your streak
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleLogin}>
                ...
                <div className="mt-4 text-center text-sm text-slate-300">
                  ...
                  <Link href="/auth/signup" className="text-blue-400 underline underline-offset-4 hover:text-blue-300">
                    Sign up
                  </Link>
                </div>
              </form>
